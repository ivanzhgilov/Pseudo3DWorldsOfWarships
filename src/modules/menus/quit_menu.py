...
class QuitMenu(MenuSprite):
    def __init__(
        ...
        self.button_continue = HoverButton(
            start_button_x, start_button_y, "Вернуться в бой", self.buttons
        )
        self.button_quit = HoverButton(
            start_button_x, start_button_y + BUTTON_HEIGHT + 50, "Выйти", self.buttons
        )
